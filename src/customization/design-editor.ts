...
export const designEditorStyles = {
    ...
    inspector: {
        ...
        controlButton: (isActive: boolean, dense = false) => ({
            ...
            px: dense ? 0.8 : 1,
            borderRadius: 12,
            background: isActive ? "rgba(146,218,112,0.16)" : "transparent",
        ...
        controlButtonLabel: (isActive: boolean, dense = false) => ({
            fontSize: dense ? "0.72rem" : "0.76rem",
            fontWeight: 700,
            letterSpacing: "-0.02em",
            color: isActive ? projectEditorTokens.layoutPrimaryAccent : sharedCustomization.text.secondary,
        }),
        ...
        togglePill: (active: boolean) => ({
            ...
            px: 0.9,
            borderRadius: 12,
            background: active ? "rgba(146,218,112,0.16)" : "rgba(255,255,255,0.04)",
            border: `1px solid ${active ? "rgba(146,218,112,0.18)" : "rgba(255,255,255,0.04)"}`,
        }),
